$(document).ready(function () {
    ...
    content.innerHTML = '<a class="navbar-brand" href="AdminPage.html">Pizza_POS</a>' +
        '<button class="navbar-toggler" type="button" data-toggle="collapse" data-target="#navbarSupportedContent" aria-controls="navbarSupportedContent" aria-expanded="false" aria-label="Toggle navigation">' +
        '<span class="navbar-toggler-icon"></span>' + '</button>';

    content.classList.add('navbar', 'navbar-expand-lg', 'navbar-dark', 'bg-info', 'fixed-top')
    ...
    navbar_nav.innerHTML = '<li class="nav-item active"><a class="nav-link" href="AdminPage.html">Home</a></li>'
    navbar_nav.innerHTML += '<li class="nav-item active"><a class="nav-link" href="NewOrder_admin.html">Order Page</a></li>'
    navbar_nav.innerHTML += '<li class="nav-item active"><a class="nav-link" href="EmployeeList.html">Employee List</a></li>'
    navbar_nav.innerHTML += '<li class="nav-item active"><a class="nav-link" href="ItemsList.html">Items List</a></li>'
